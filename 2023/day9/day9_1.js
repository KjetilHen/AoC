...
function extrapolatedValuesSum(predictions) {
    ...
    console.log("🚀 ~ file: day9_1.js:108 ~ extrapolatedValuesSum ~ predictions:", predictions)
    for (let index = predictions.length - 1; index >= 0; index--) {
            const prediction = predictions[index];
            console.log("🚀 ~ file: day9_1.js:111 ~ extrapolatedValuesSum ~ prediction:", prediction)
            const lastPrediction = predictions[index + 1]?.[predictions[index + 1]?.[0]] ?? 0;
            console.log("🚀 ~ file: day9_1.js:112 ~ extrapolatedValuesSum ~ lastPrediction:", lastPrediction)
